...
export const BOARD_HELP_HISTORY =
  "表示モード「履歴」では SolidWorks / CADMAC / 両方を切り替え、完了したタスクだけを確認できます。";

export const BOARD_HELP_ACTIVE_HISTORY_HINT =
  "アクティブ＝完了以外のタスク。履歴＝完了済みのみ。CADMAC 表示時も、SolidWorks 側の完了条件に沿って進められます。";
...
export const MY_TASKS_HELP_INPUT =
  "スライダーで進捗％、テキストで進捗メモを入力し、一覧でまとめて保存します。更新は担当者または管理者のみ可能です。";
